...
class NumberingDocumentDBPurchase {
    ...
    public static function getFormatNumber($model, $attributePk, $attributeNo, $attributeMonth, $attributeYear, $valuepk = 0) {
        ...
        if ($query) {
            ...
            $yearnow = NumberingDocumentDBPurchase::getYearNow();
            $monthnow = NumberingDocumentDBPurchase::getMonthNow();
            ...
            $DocumentCode = NumberingDocumentDBPurchase::getDocumentCode();
            $RomawiMonth = NumberingDocumentDBPurchase::getRomawiMonth($monthnow);
