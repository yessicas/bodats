...
class NumberingDocumentDBFinding {
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBFinding::getYearNow();
	    $monthnow=NumberingDocumentDBFinding::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBFinding::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBFinding::getRomawiMonth($monthnow);
