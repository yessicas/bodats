...
class NumberingDocumentDBSOOFFHIRED {
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBSOOFFHIRED::getYearNow();
	    $monthnow=NumberingDocumentDBSOOFFHIRED::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBSOOFFHIRED::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBSOOFFHIRED::getRomawiMonth($monthnow);
