...
class NumberingDocumentDBPurchaseOrder {
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBPurchaseOrder::getYearNow();
	    $monthnow=NumberingDocumentDBPurchaseOrder::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBPurchaseOrder::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBPurchaseOrder::getRomawiMonth($monthnow);
