 ...
 */
class TbGridViewNew extends CGridView
{
	// Table types.
	...
	// must costum 
	public $headerCustom = false;
	public $contentHeaderCustom='';
	...
	public function renderTableHeader()
	{
		if(!$this->hideHeader)
		{
			...
			if($this->headerCustom){
				echo $this->contentHeaderCustom; // content costum header
			}else{
				echo "<tr>\n";
