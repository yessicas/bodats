<?php
class NumberingDocumentDBDamage {
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBDamage::getYearNow();
	    $monthnow=NumberingDocumentDBDamage::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBDamage::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBDamage::getRomawiMonth($monthnow);
