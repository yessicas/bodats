...
class NumberingDocumentDBSailingOrder {
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBSailingOrder::getYearNow();
	    $monthnow=NumberingDocumentDBSailingOrder::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBSailingOrder::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBSailingOrder::getRomawiMonth($monthnow);
