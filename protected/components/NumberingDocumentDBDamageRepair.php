...
class NumberingDocumentDBDamageRepair {
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBDamageRepair::getYearNow();
	    $monthnow=NumberingDocumentDBDamageRepair::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBDamageRepair::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBDamageRepair::getRomawiMonth($monthnow);
