...
class NumberingDocumentDBSO {
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBSO::getYearNow();
	    $monthnow=NumberingDocumentDBSO::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBSO::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBSO::getRomawiMonth($monthnow);
    ...
    if($query){
		...
		$DocumentCode= NumberingDocumentDBSO::getDocumentCode2();
		$DocumentCode2= NumberingDocumentDBSO::getDocumentCode3();
	    $RomawiMonth= NumberingDocumentDBSO::getRomawiMonth($monthnow);
