<?php
class NumberingDocumentDBSPAL {
	
	
	public static function getFormatNumber($model,$attributePk,$attributeNo,$attributeMonth,$attributeYear,$valuepk=0){
		
	$criteria = new CDbCriteria();
	$criteria->condition = $attributePk.'<>:'.$attributePk.' AND SpalNumber <> "" '; 
	$criteria->params = array(':'.$attributePk=>$valuepk);
    ...
    if($query){
	    ...
	    $yearnow=NumberingDocumentDBSPAL::getYearNow();
	    $monthnow=NumberingDocumentDBSPAL::getMonthNow();
		...
		$DocumentCode= NumberingDocumentDBSPAL::getDocumentCode();
	    $RomawiMonth= NumberingDocumentDBSPAL::getRomawiMonth($monthnow);
    ...
    if($query){
		...
		$DocumentCode= NumberingDocumentDBSPAL::getDocumentCode2();
		$DocumentCode2= NumberingDocumentDBSPAL::getDocumentCode3();
	    $RomawiMonth= NumberingDocumentDBSPAL::getRomawiMonth($monthnow);
