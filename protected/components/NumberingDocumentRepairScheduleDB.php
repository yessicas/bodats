...
class NumberingDocumentRepairScheduleDB {

    public static function getFormatNumber($model, $attributePk, $attributeNo, $attributeMonth, $attributeYear, $valuepk = 0) {

        $criteria = new CDbCriteria();
        $criteria->condition = $attributePk . '<>:' . $attributePk . ' AND SchNumber<>:SchNumber';
        $criteria->params = array(':' . $attributePk => $valuepk, ':SchNumber' => '');
        ...
        if ($query) {
            ...
            $yearnow = NumberingDocumentRepairScheduleDB::getYearNow();
            $monthnow = NumberingDocumentRepairScheduleDB::getMonthNow();
            ...
            $RomawiMonth = NumberingDocumentRepairScheduleDB::getRomawiMonth($monthnow);
