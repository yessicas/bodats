...
class AccountGlController extends Controller
{
	/**
	...
	*/
	...
	if(isset($_POST['AccountGl']))
	{
	$model->attributes=$_POST['AccountGl'];
	if($model->save()){
	Yii::app()->user->setFlash('success', " Data Saved");
	$this->redirect(array('admin','id'=>$model->id_account_gl));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('AccountGl');
	...
	*/
	...
	{
	$model=new AccountGl('search');
	$model->unsetAttributes();  // clear any default values
	if(isset($_GET['AccountGl']))
	$model->attributes=$_GET['AccountGl'];
	...
	*/
	...
	{
	$model=AccountGl::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='account-gl-form')
	{
