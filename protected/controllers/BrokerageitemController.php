...
class BrokerageitemController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BrokerageItem']))
		{
			...
			if($model->save()){
				...
				$this->redirect(array('view','id'=>$model->id_brokerage_item));
			}
		}
		if(Yii::app()->request->getIsAjaxRequest())
		{
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['BrokerageItem']))
		{
			...
			if($model->save())
			{
				...
				$this->redirect(array('master/masbrok','id'=>$model->id_brokerage_item));
			}
		}
		if(Yii::app()->request->getIsAjaxRequest())
		{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('BrokerageItem');
	...
	*/
	...
	{
		$model=BrokerageItem::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='brokerage-item-form')
		{
