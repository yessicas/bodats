...
class JettyController extends Controller
{
	...
	*/
	...
	$this->redirect(array('view','id'=>$model->JettyId));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	$this->redirect(array('admin','id'=>$model->JettyId));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('Jetty');
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='jetty-form')
	{
