...
class MstVoyageDocumentController extends Controller
{
	/**
	...
	*/
	...
	$this->redirect(array('master/voydoc','id'=>$model->IdVoyageDocument));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('MstVoyageDocument');
	...
	*/
	...
	{
	$model=MstVoyageDocument::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='mst-voyage-document-form')
	{
