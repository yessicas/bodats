...
class SurveyItemController extends Controller
{
	...
	*/
	...
	{
		$model=new SurveyItem;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['SurveyItem']))
		{
			$model->attributes=$_POST['SurveyItem'];
			if($model->save()){
				Yii::app()->user->setFlash('success', " Data Saved");
				$this->redirect(array('view','id'=>$model->id_survey_item));
			}
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['SurveyItem']))
		{
			...
			if($model->save())
			{
				...
				$this->redirect(array('admin','id'=>$model->id_survey_item));
			}
		}
		if(Yii::app()->request->getIsAjaxRequest())
		{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('SurveyItem');
	...
	*/
	...
	{
		$model=new SurveyItem('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SurveyItem']))
		$model->attributes=$_GET['SurveyItem'];
	...
	*/
	...
	{
		$model=SurveyItem::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='survey-item-form')
		{
