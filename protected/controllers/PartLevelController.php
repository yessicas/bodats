...
class PartLevelController extends Controller
{
	/**
	...
	*/
	public function actionCreate()
	{
		...
		if(isset($_POST['PartLevel']))
		{
			$model->attributes=$_POST['PartLevel'];
			if($model->save()){
				Yii::app()->user->setFlash('success', " Data Saved");
				$this->redirect(array('admin','id'=>$model->id_part_level));
			}
		}
		if(Yii::app()->request->getIsAjaxRequest())
		{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('PartLevel');
	...
	*/
	...
	{
		$model=new PartLevel('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PartLevel']))
			$model->attributes=$_GET['PartLevel'];
	...
	*/
	...
	{
		$model=PartLevel::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='part-level-form')
		{
