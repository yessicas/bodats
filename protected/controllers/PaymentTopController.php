...
class PaymentTopController extends Controller
{
/**
...
$this->redirect(array('view','id'=>$model->id_payment_top));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->id_payment_top));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('PaymentTop');
...
{
$model=PaymentTop::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='payment-top-form')
{
