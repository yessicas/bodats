...
class SettingSpalReportController extends Controller
{
/**
...
$this->redirect(array('setting/spal','id'=>$model->id_setting_spal_report));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('SettingSpalReport');
...
{
$model=SettingSpalReport::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='setting-spal-report-form')
{
