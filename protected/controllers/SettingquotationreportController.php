...
class SettingQuotationReportController extends Controller
{
/**
...
$this->redirect(array('setting/quot','id'=>$model->id_setting_quotation_report));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('SettingQuotationReport');
...
{
$model=SettingQuotationReport::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='setting-quotation-report-form')
{
