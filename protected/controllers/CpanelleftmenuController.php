...
class CpanelLeftmenuController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['CpanelLeftmenu'])) {
            ...
            if ($model->save()) {
                ...
                $this->redirect(array('master/masleft', 'id' => $model->id_leftmenu));
            }
        }
        if (Yii::app()->request->getIsAjaxRequest()) {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('CpanelLeftmenu');
    ...
    public function loadModel($id) {
        $model = CpanelLeftmenu::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'cpanel-leftmenu-form') {
