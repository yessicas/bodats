...
class FuelTransactionTypeController extends Controller
{
/**
...
$this->redirect(array('master/masfuel','id'=>$model->id_fuel_transaction_type));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('FuelTransactionType');
...
{
$model=FuelTransactionType::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='fuel-transaction-type-form')
{
