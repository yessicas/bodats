...
class MstMetricController extends Controller
{
	/**
	...
	*/
	...
	$this->redirect(array('master/mastric','id'=>$model->metric));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('MstMetric');
	...
	*/
	...
	{
	$model=MstMetric::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='mst-metric-form')
	{
