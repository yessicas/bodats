...
$modeldetailquotation=new QuotationDetailVessel('searchbyquotation');
$modeldetailquotation->unsetAttributes();  // clear any default values
if(isset($_GET['QuotationDetailVessel']))
$modeldetailquotation->attributes=$_GET['QuotationDetailVessel'];


$modeldetail=new ShippingOrderDetail('searchbyshippingorder');
$modeldetail->unsetAttributes();  // clear any default values
if(isset($_GET['ShippingOrderDetail']))
$modeldetail->attributes=$_GET['ShippingOrderDetail'];


$this->render('view',array(
'model'=>$this->loadModel($id),
'modeldetailquotation'=>$modeldetailquotation,
...
$this->redirect(array('view','id'=>$model->id_shipping_order));
}
}
...
{
$dataProvider=new CActiveDataProvider('ShippingOrder');
...
{
$model=ShippingOrder::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='shipping-order-form')
{
