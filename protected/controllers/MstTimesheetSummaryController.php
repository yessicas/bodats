...
class MstTimesheetSummaryController extends Controller
{
/**
...
$this->redirect(array('view','id'=>$model->id_mst_timesheet_summary));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->id_mst_timesheet_summary));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('MstTimesheetSummary');
...
{
$model=MstTimesheetSummary::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='mst-timesheet-summary-form')
{
