...
class VendorBankAccController extends Controller
{
/**
...
{
$model=new VendorBankAcc;

// Uncomment the following line if AJAX validation is needed
// $this->performAjaxValidation($model);

if(isset($_POST['VendorBankAcc']))
{
$model->attributes=$_POST['VendorBankAcc'];
if($model->save()){
Yii::app()->user->setFlash('success', " Data Saved");
$this->redirect(array('custvend/vendview','id'=>$model->id_vendor));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('VendorBankAcc');
...
{
$model=new VendorBankAcc('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['VendorBankAcc']))
$model->attributes=$_GET['VendorBankAcc'];
...
{
$model=VendorBankAcc::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='vendor-bank-acc-form')
{
