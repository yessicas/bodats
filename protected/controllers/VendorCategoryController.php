...
$this->redirect(array('view','id'=>$model->id_vendor_category));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->id_vendor_category));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('VendorCategory');
...
{
$model=new VendorCategory('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['VendorCategory']))
$model->attributes=$_GET['VendorCategory'];
...
{
$model=VendorCategory::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='vendor-category-form')
{
