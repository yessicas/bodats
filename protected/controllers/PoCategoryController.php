...
$this->redirect(array('view','id'=>$model->id_po_category));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('master/maspo','id'=>$model->id_po_category));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('PoCategory');
...
{
$model=PoCategory::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='po-category-form')
{
