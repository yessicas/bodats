...
class BussinesstypeorderController extends Controller
{
/**
...
$this->redirect(array('master/mastypeview','id'=>$model->id_bussiness_type_order));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('master/mastype','id'=>$model->id_bussiness_type_order));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('BussinessTypeOrder');
...
{
$model=BussinessTypeOrder::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='bussiness-type-order-form')
{
