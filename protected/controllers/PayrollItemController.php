...
$this->redirect(array('master/masrol','id'=>$model->id_payroll_item));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('PayrollItem');
...
{
$model=PayrollItem::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='payroll-item-form')
{
