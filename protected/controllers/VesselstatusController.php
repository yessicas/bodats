...
$this->redirect(array('view','id'=>$model->id_vessel_status));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->id_vessel_status));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('VesselStatus');
...
{
$model=VesselStatus::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='vessel-status-form')
{
