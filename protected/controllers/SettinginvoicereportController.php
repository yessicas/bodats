...
class SettingInvoiceReportController extends Controller
{
/**
...
$this->redirect(array('view','id'=>$model->id_setting_quotation_report));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->id_setting_quotation_report));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('SettingInvoiceReport');
...
{
$model=SettingInvoiceReport::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='setting-invoice-report-form')
{
