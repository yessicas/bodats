...
class MstVesselDocumentValidityController extends Controller
{
	/**
	...
	*/
	...
	$this->redirect(array('view','id'=>$model->id_vessel_document_validity));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	$this->redirect(array('master/valid','id'=>$model->id_vessel_document_validity));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('MstVesselDocumentValidity');
	...
	*/
	...
	{
	$model=MstVesselDocumentValidity::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='mst-vessel-document-validity-form')
	{
