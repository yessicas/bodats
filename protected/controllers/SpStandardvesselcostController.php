...
class SpStandardVesselCostController extends Controller
{
	/**
	...
	*/
	...
	{
		$model=new SpStandardVesselCost;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['SpStandardVesselCost']))
		{
		$model->attributes=$_POST['SpStandardVesselCost'];
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('SpStandardVesselCost');
	...
	*/
	...
	{
		$model=new SpStandardVesselCost('search');
		$model->unsetAttributes();  // clear any default values
		if($id_vessel > 0)
			$model->id_vessel = $id_vessel;
			
		if(isset($_GET['SpStandardVesselCost']))
		$model->attributes=$_GET['SpStandardVesselCost'];
	...
	*/
	...
	{
		$model=SpStandardVesselCost::model()->findByPk($id);
		if($model===null)
	...
	{
		$es = new EditableSaver('SpStandardVesselCost');
		try {
