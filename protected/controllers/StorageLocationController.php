...
$this->redirect(array('view','id'=>$model->StorageLocationId));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->StorageLocationId));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('StorageLocation');
...
{
$model=StorageLocation::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='storage-location-form')
{
