...
class VoyageMstActivityController extends Controller
{
/**
...
$this->redirect(array('master/masvoy','id'=>$model->id_voyage_activity));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('VoyageMstActivity');
...
{
$model=VoyageMstActivity::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='voyage-mst-activity-form')
{
