...
class RentItemController extends Controller
{
	...
	*/
	public function actionCreate()
	{
		...
		if(isset($_POST['RentItem']))
		{
		$model->attributes=$_POST['RentItem'];
		if($model->save()){
		Yii::app()->user->setFlash('success', " Data Saved");
		$this->redirect(array('view','id'=>$model->id_rent_item));
		}
		}
		if(Yii::app()->request->getIsAjaxRequest())
		{
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['RentItem']))
		{
			...
			if($model->save())
			{
				...
				$this->redirect(array('admin','id'=>$model->id_rent_item));
			}
		}
		if(Yii::app()->request->getIsAjaxRequest())
		{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('RentItem');
	...
	*/
	...
	{
		$model=new RentItem('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RentItem']))
		$model->attributes=$_GET['RentItem'];
	...
	*/
	...
	{
		$model=RentItem::model()->findByPk($id);
		if($model===null)
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rent-item-form')
		{
