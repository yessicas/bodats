...
$this->redirect(array('master/mascer','id'=>$model->id_certificate));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('CertificateLevel');
...
{
$model=CertificateLevel::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='certificate-level-form')
{
