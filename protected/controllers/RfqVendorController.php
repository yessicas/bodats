	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','autovendor'),
				'users'=>array('admin'),
			),
...
$model->attributes=$_POST['RfqVendor'];
	...
	$this->redirect(array('admin','id'=>$model->id_rfq_vendor));
	}
	}
}
}
...
'model'=>$model,
	...
	{
		$dataProvider=new CActiveDataProvider('RfqVendor');
	...
	{
		$model=RfqVendor::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rfq-vendor-form')
		{
