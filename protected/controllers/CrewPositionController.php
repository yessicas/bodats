...
class CrewPositionController extends Controller
{
	...
	*/
	...
	$this->redirect(array('view','id'=>$model->id_crew_position));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	$this->redirect(array('master/mascrewadmin','id'=>$model->id_crew_position));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('CrewPosition');
	...
	*/
	...
	{
	$model=CrewPosition::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='crew-position-form')
	{
