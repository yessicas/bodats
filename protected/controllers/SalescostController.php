...
class SalescostController extends Controller
{
	...
	*/
	...
	if($model->save())
	$this->redirect(array('view','id'=>$model->id_sales_cost));
	}
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('SalesCost');
	...
	*/
	...
	{
	$model=SalesCost::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='sales-cost-form')
	{
