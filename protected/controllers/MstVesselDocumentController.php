...
class MstVesselDocumentController extends Controller
{
/**
...
$this->redirect(array('view','id'=>$model->id_vessel_document));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->id_vessel_document));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('MstVesselDocument');
...
public function actionExportToFile() {
                ...
                header('Content-Disposition: attachment; filename="report-vesseldocument-' . date('YmdHi') .'.csv"');
                ...
                // csv header
                echo   			MstVesselDocument::model()->getAttributeLabel("VesselType").",". 
                                MstVesselDocument::model()->getAttributeLabel("VesselDocumentName").",". 
                                MstVesselDocument::model()->getAttributeLabel("Dasar").",".
                               // MstVesselDocument::model()->getAttributeLabel("Status").",".
                                MstVesselDocument::model()->getAttributeLabel("Status").
                                " \r\n";
                // csv data
                foreach ($dataProvider->getData() as $data) {
                        echo "$data->VesselType, $data->VesselDocumentName, $data->Dasar, $data->Status \r\n";
                }
...
{
$model=MstVesselDocument::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='mst-vessel-document-form')
{
