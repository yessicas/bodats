...
class StandardagencyController extends Controller
{
	/**
	...
	*/
	...
	{
	$model->attributes=$_POST['StandardAgency'];
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('StandardAgency');
	...
	*/
	...
	{
	$model=new StandardAgency('search');
	$model->unsetAttributes();  // clear any default values
	if(isset($_GET['StandardAgency']))
	$model->attributes=$_GET['StandardAgency'];
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='standard-agency-form')
	{
	...
	{
		$es = new EditableSaver('StandardAgency');
		try {
