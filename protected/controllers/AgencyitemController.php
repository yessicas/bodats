...
class AgencyitemController extends Controller
{
	...
	*/
	...
	$this->redirect(array('view','id'=>$model->id_agency_item));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	$this->redirect(array('master/agen','id'=>$model->id_agency_item));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('AgencyItem');
	...
	*/
	...
	{
	$model=AgencyItem::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='agency-item-form')
	{
