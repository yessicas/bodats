...
$this->redirect(array('setting/general','id'=>$model->id_setting_general));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('SettingGeneral');
...
{
$model=SettingGeneral::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='setting-general-form')
{
