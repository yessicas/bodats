...
class MstDebitNoteCategoryController extends Controller
{
/**
...
$this->redirect(array('view','id'=>$model->id_debit_note_category));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
$this->redirect(array('admin','id'=>$model->id_debit_note_category));
}
}
if(Yii::app()->request->getIsAjaxRequest())
{
...
{
$dataProvider=new CActiveDataProvider('MstDebitNoteCategory');
...
{
$model=MstDebitNoteCategory::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='mst-debit-note-category-form')
{
