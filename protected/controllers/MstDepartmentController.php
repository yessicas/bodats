...
if($model->save())
{
					Yii::app()->user->setFlash('success', "Data $model->DepartmentName Saved");
...
if($model->save())
{
					Yii::app()->user->setFlash('success', "Data $model->DepartmentName Updated");
					$this->redirect(array('master/masdept','id'=>$model->DepartmentId));
}
}
...
if(!isset($_GET['ajax']))
Yii::app()->user->setFlash('success', " Data '$model->DepartmentName' has deleted.");
...
{
$dataProvider=new CActiveDataProvider('MstDepartment');
...
{
$model=MstDepartment::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='mst-department-form')
{
