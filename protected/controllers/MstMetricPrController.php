...
class MstMetricPrController extends Controller
{
	/**
	...
	*/
	...
	$this->redirect(array('view','id'=>$model->metric));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	$this->redirect(array('master/maspr','id'=>$model->metric));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('MstMetricPr');
	...
	*/
	...
	{
	$model=MstMetricPr::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='mst-metric-pr-form')
	{
