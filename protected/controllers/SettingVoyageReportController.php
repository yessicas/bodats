...
class SettingVoyageReportController extends Controller
{
	/**
	...
	*/
	...
	$this->redirect(array('view','id'=>$model->id_setting_tax_report));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	$this->redirect(array('admin','id'=>$model->id_setting_tax_report));
	}
	}
	if(Yii::app()->request->getIsAjaxRequest())
	{
	...
	*/
	...
	{
	$dataProvider=new CActiveDataProvider('SettingVoyageReport');
	...
	*/
	...
	{
	$model=SettingVoyageReport::model()->findByPk($id);
	if($model===null)
	...
	*/
	...
	{
	if(isset($_POST['ajax']) && $_POST['ajax']==='setting-voyage-report-form')
	{
