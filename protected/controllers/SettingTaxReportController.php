...
class SettingTaxReportController extends Controller
{
/**
...
{
$dataProvider=new CActiveDataProvider('SettingTaxReport');
...
{
$model=SettingTaxReport::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='setting-tax-report-form')
{
