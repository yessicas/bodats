...
VoyageOrderDisplayer::displayTabLabelSailingOrder($this,2);
...
'columns'=>array(
		...
		*/	
		array(  'header'=>'Loading Date (Schedule)',
                'name'=>'StartDate',
                'value'=>'Timeanddate::getDisplayStandardDate($data->StartDate)',
                ),
		array(  'header'=>'Start Voyage',
                'name'=>'ActualStartDate',
                'value'=>'Timeanddate::getDisplayStandardDate($data->ActualStartDate)',
                ),
		...
		*/
		...
		'buttons'=>array(
                'update'=>
                    array(
                        'label'=>'Update',
                        'url'=> 'Yii::app()->createUrl("sailingorder/update",array("id"=>$data->id_voyage_order))',
                        'options'=>array(
                            'class'=>'',
                            'rel'=>'',
                        ),
                ...
                'view'=>
                    array(
                        'label'=>'View',
                        'url'=> 'Yii::app()->createUrl("sailingorder/view",array("id"=>$data->id_voyage_order))',
                        'options'=>array(
                            'class'=>'',
                            'rel'=>'',
                        ),
