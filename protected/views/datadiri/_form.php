...
<?php echo $form->errorSummary($model); ?>
    ...
    <?php echo $form->textFieldRow($model,'handphone',array('class'=>'span2','maxlength'=>13)); ?>

    <?php echo $form->dropDownListRow($model,'id_last_job_status',CHtml::listData(MstJobStatus::model()->findAll(), 'id_mst_job_status', 'status'),
...
<?php /*
    <?php echo $form->labelEx($model,'last_job_status_date'); ?>
	<?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
	'model'=>$model,
	//'language'=>Yii::app()->language='id',
	'attribute'=>'last_job_status_date',
	'options'=>array(
						'showAnim'=>'slideDown',
						'dateFormat'=>'yy-mm-dd',          
						'changeMonth'=>true,
	...
	<?php echo $form->error($model,'last_job_status_date'); ?>

	<?php echo $form->dropDownListRow($model,'last_status_education',array('GRADUATED'=>'GRADUATED', 'STUDENT'=>'STUDENT'),
    array('prompt'=>'--Pilih --','class'=>'span2'));?>

    <?php echo $form->textFieldRow($model,'school_name',array('class'=>'span3','maxlength'=>150)); ?>

     <?php echo $form->labelEx($model,'graduated_date'); ?>
	<?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
	'model'=>$model,
	//'language'=>Yii::app()->language='id',
	'attribute'=>'graduated_date',
	'options'=>array(
						'showAnim'=>'slideDown',
						'dateFormat'=>'yy-mm-dd',          
						'changeMonth'=>true,
	...
	<?php echo $form->textFieldRow($model,'student_entry_year',array('class'=>'span1','maxlength'=>4)); ?>

	<?php //echo $form->dropDownListRow($model,'jenis_kelamin',array(1=>'Laki - Laki', 2=>'Perempuan'),
    //array('prompt'=>'--Pilih --','class'=>'span2'));?>

	<?php echo $form->dropDownListRow($model,'last_status_work',array('WORK'=>'WORK', 'JOBLESS'=>'JOBLESS','FREELANCE'=>'FREELANCE','PARTTIME'=>'PARTTIME'),
    array('prompt'=>'--Pilih --','class'=>'span2'));?>

     <?php echo $form->labelEx($model,'status_work_date'); ?>
	<?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
	'model'=>$model,
	//'language'=>Yii::app()->language='id',
	'attribute'=>'status_work_date',
	'options'=>array(
						'showAnim'=>'slideDown',
						'dateFormat'=>'yy-mm-dd',          
						'changeMonth'=>true,
	...
	<?php echo $form->error($model,'status_work_date'); ?>
	
	<?php echo $form->textFieldRow($model,'work_place_name',array('class'=>'span3','maxlength'=>150)); ?>
   ...
   // array('prompt'=>'--Pilih --','class'=>'span2'));?>
	...
	<?php //echo '<div style="margin-bottom:20px;"><b>-</b></div>'; ?>
