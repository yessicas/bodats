...
<?php echo $form->errorSummary($model); ?>
	...
	if($model->isNewRecord){
		...
		echo 'No. '.$form->textField($model,'SpalNumber',array('class'=>'span3','maxlength'=>32,'readonly'=>'readonly')); 
	}
	?>
	</div align="center">
	...
	<tr class="even">
		...
		<td style="border-left: 1px solid #fff ; vertical-align:top;text-align:left;width:48%">		
		JENIS MUATAN :	<br>
		<?php echo $form->textField($model,'JenisMuatan',array('class'=>'span5','maxlength'=>250)); ?>
	...
	<tr class="even">
		...
		JUMLAH MUATAN :	<br>
		<?php if($modelquo->id_bussiness_type_order!=250){ ?>
		Deadfreight : <?php echo NumberAndCurrency::formatNumber(GeneralDB::getlastBigListQuotation($modelquo->id_quotation)->Capacity).' MT '; ?>  <br>
		<?php } ?>
		<?php echo $form->textArea($model,'TotalMaxMuatan',array('class'=>'span9', 'rows'=>3, 'cols'=>150, 'maxlength'=>250)); ?>
	...
	<tr class="even">
		...
		<td style="border-left: 1px solid #fff ; vertical-align:top;text-align:left;width:48%">		
		KONDISI ANGKUTAN :	<br>
		<?php echo $form->textField($model,'KondisiAngkutan',array('class'=>'span5','maxlength'=>250)); ?>
	...
	<tr class="even">
		...
		<?php echo $form->textField($model,'PengirimanBarang',array('class'=>'span5','maxlength'=>250)); ?>
	...
	<tr class="even">
		...
		<td style="border-left: 1px solid #fff ; vertical-align:top;text-align:left;width:48%">		
		KEAGENAN KAPAL :	<br>
		<?php echo $form->textField($model,'KeagenanKapal',array('class'=>'span7','maxlength'=>250)); ?>
	...
	<tr class="even">
		...
		<td style="border-left: 1px solid #fff ;vertical-align:top;text-align:left;width:48%">		
		ASURANSI KAPAL :	<br>
		<?php echo $form->textField($model,'AsuransiKapal',array('class'=>'span7','maxlength'=>250)); ?>
		...
		<td style="border-left: 1px solid #fff ; vertical-align:top;text-align:left;width:48%">		
		ASURANSI BARANG :	<br>
		<?php echo $form->textField($model,'AsuransiBarang',array('class'=>'span7','maxlength'=>250)); ?>
