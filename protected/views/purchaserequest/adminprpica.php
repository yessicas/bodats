...
table tr td.morethreeday {
	...
	$this->menu=array(
	array('label'=>'PICA - Lead Time PR to PO','url'=>array('purchaserequest/adminprpica')),
	);
	?>
...
<div id="content">
<h2>PICA - Lead Time PR to PO</h2>
<hr>

</div>

<div class="alert alert-info">PICA (Problem Identification & Corrective Action) for Lead Time PR to PO</div>
...
'columns'=>array(
		...
		array(
		 'header'=>'PICA',
		 'class'=>'bootstrap.widgets.TbButtonColumn',
		 'template'=>'{create} {views} {updates}',
		 'htmlOptions'=>array('width'=>'150px'),
		 'buttons'=>array(
                    'create'=>
						array(
							//'icon'=>'share',
							'url'=> 'Yii::app()->createUrl("purchaseRequestPica/create",array("id"=>$data->id_purchase_request))',
							'label'=>'Create PICA',
							'visible'=>'PICADB::getPICAPRStatus($data->id_purchase_request) == 0',
							'options'=>array(
					 ...
					 'views'=>
						array(
							//'icon'=>'share',
							'url'=> 'Yii::app()->createUrl("purchaseRequestPica/view",array("id"=>$data->id_purchase_request))',
							'label'=>'View PICA',
							'visible'=>'PICADB::getPICAPRStatus($data->id_purchase_request) == 1',
							'options'=>array(
						...
						array(
							//'icon'=>'share',
							'url'=> 'Yii::app()->createUrl("purchaseRequestPica/update",array("id"=>$data->id_purchase_request))',
							'label'=>'Update PICA',
							'visible'=>'PICADB::getPICAPRStatus($data->id_purchase_request) == 1',
							'options'=>array(
