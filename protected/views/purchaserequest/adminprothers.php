...
$this->menu=array(
	...
	array('label'=>'Manage PR '.TextDisplayHelper::displayLabelFromMode($label),'url'=>array('purchaserequest/admothers/mode/'.$label), 'active'=>true),
		...
		/*
		 array(
            ...
            'value'=>function($data) {
					...
					return	CHtml::link("Download", Yii::app()->controller->createUrl("purchaserequest/download",array("id"=>$data->id_purchase_request)), array("target"=>"_blank","title"=>"Download Attachment"));
