...
<center>
<h3 class= "header"><img src="repository/icon/pending.png"> <?php echo Yii::t('strings','Pending Request') ?>
<span class="header-line"><img src="repository/icon/headline.png"></span>
</h3>
</center>

<!--<div class="well">
<h4><img src="repository/icon/pending.png"> <?php //echo Yii::t('strings','Pending Request') ?></h4>
<hr>
</div>
-->
