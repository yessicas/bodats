<div class="view">
		...
		<?php /* <b><?php echo CHtml::encode($data->getAttributeLabel('id_data_diri')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_data_diri),array('Viewprofile','id'=>$data->id_data_diri,"c"=>SecurityGenerator::SecurityDisplay($data->code_id))); ?>
	<br />
...
-->
	*/ ?>
	...
	<?php echo CHtml::link(CHtml::encode($data->nama_lengkap),array('datadiri/Viewprofile','id'=>$data->id_data_diri,'c'=>SecurityGenerator::SecurityDisplay($data->code_id))); ?>
	<br />
...
-->
	...
	<?php echo CHtml::encode($data->getjk()); ?>
