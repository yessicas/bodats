<?php if ($type=='IDV'||$type=='ADM'){
		...
		<!-- nama dan tempat user  berdasarkan type-->
		<td width = "520">
			<?php if ($type=='IDV'){

			$contentpopoveridv='<table><tr><td style=width:100px;><div style="width:100px;">'.$fotoidv.'</td>
			...
			$contentpopoveretp='<table><tr><td style=width:100px;><div style="width:100px;">'.$fotoetp.'</td>
			...
			$contentpopoverskl='<table><tr><td style=width:100px;><div style="width:100px;">'.$fotoskl.'</td>
