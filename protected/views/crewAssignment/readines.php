...
$this->menu=array(
array('label'=>'List of Vessel Crew Readiness', 'url'=>array('cre/listofvessel','mode'=>'readiness')),
array('label'=>'Crew Readiness','url'=>array('cre/readines'),'active'=>true),
);
?>
...
<div class="userlistviewall" style="display:inline">
	<?php 
		$this->renderPartial('../crewAssignment/CrewReadines',array('id_tug'=>$id_tug)); 
	?>
</div>
