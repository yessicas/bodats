...
<center>
<h3 class= "header"><img src="repository/icon/blockbig.png"> <?php echo Yii::t('strings','Rejected Article') ?>
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'dataProvider'=>$model->rejectedarticle(),
	...
	'columns'=>array(
		...
		*/
		...
		'name'=>'isAprroved',
		'value' => 'CHtml::encode($data->statusapproval())',
		'filter'=> CHtml::TextField('isAprroved', 'Rejected',array('readonly'=>'readonly')),
		),
