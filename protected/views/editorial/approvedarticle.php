...
<center>
<h3 class= "header"><img src="repository/icon/appbig.png"> <?php echo Yii::t('strings','Approved Article') ?>
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'dataProvider'=>$model->approvedarticle(),
	...
	'columns'=>array(
        ...
        */
		...
		'filter'=>array('0'=>'Draft', '1'=>'Published', '2'=>'Rejected'),
		...
		*/
		...
		'name'=>'isAprroved',
		'value' => 'CHtml::encode($data->statusapproval())',
		'filter'=> CHtml::TextField('isAprroved', 'Approved',array('readonly'=>'readonly','style'=>'width:60px; margin-right:-10px;')),
		),
