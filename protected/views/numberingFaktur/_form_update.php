...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldRow($model,'prefix_number',array('class'=>'span5','maxlength'=>150, 'readonly'=>true)); ?>
	...
	<?php echo $form->dropDownlistRow($model,'status',array("NOT TAKEN"=>"NOT TAKEN","TAKE"=>"TAKE","RESERVE"=>"RESERVE"),
