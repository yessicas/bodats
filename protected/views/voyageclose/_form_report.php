...
var start = new Date($('#VoyageClose_ActualStartDate').val()); 
var end = new Date($('#VoyageClose_ActualEndDate').val())  
...
<?php echo $form->textFieldRow($model,'ActualLayTime',array('class'=>'span3')); ?>
<?php echo $form->textFieldRow($model,'StartFuelStock',array('class'=>'span3','value'=>VoyageCloseDB::getDataSailingOrderByIdVoyageOrder($modelvoyage->id_voyage_order)->LastFuelStock,'readonly'=>'readonly')); ?>
<?php echo $form->textFieldRow($model,'LastFuelStock',array('class'=>'span3','onChange' => 'javascript:hitung_fuel()')); ?>

<div class="control-group ">
<label class="control-label required" ><?php echo $model::model()->getAttributeLabel('Consumpt'); ?> <span class="required">*</span></label> <!-- label -->
<div class="controls">
<?php echo Chtml::textField('consumpt','',array('class'=>'span3','readonly'=>'readonly')); ?>
</div>
</div>
</div>
*/ ?>
...
<table class="tabel_border_o" style =" font-family: 'Calibri';font-size: 12px;">
	...
	<tr>
		...
		<?php echo Chtml::textField('CrewName',CrewDB::getCrewNameMasterCrewByVessel2($modelvoyage->VesselTug->id_vessel),array('class'=>'span7','readonly'=>'readonly')); ?>
+		<?php echo $form->hiddenField($model,'CrewIdMaster',array('class'=>'span5','value'=>CrewDB::getIdMasterCrewByVessel2($modelvoyage->VesselTug->id_vessel))); ?>
		<br>
	...
	<td style="vertical-align:top;" >
		...
		<td style="width:20%;vertical-align:top;text-align:center;padding: 5px 0px;" class="no_borderleft"  colspan='3'>
				...
				<tr class="even" >
					...
					<td style="vertical-align:top;text-align:left;" class="no_borderleft">
					<?php echo $form->textField($model,'ActualFuel',array('class'=>'span5','value'=>$model->ConsumptFuel,'readonly'=>'readonly')); ?> Liter
					<br>
				...
				<tr class="even" >
					...
					<td style="vertical-align:top;text-align:left;" class="no_borderleft">
					<?php echo $form->textField($model,'StandardLayTime',array('class'=>'span5','value'=>StandardFuelDB::getStandardFuel($modelvoyage->BargingVesselTug,$modelvoyage->BargingVesselBarge,$modelvoyage->BargingJettyIdStart,$modelvoyage->BargingJettyIdEnd)->cycle_time,
					'readonly'=>'readonly')); ?> Hari 
					<br>
					...
					<?php echo Chtml::textField('dayslaytime',$konversiminutetodays,array('class'=>'span5','readonly'=>'readonly')); ?> Hari
					<?php echo $form->hiddenField($model,'ActualLayTime',array('class'=>'span5')); ?> 
					<br>
		...
		<td style="width:20%;vertical-align:top;text-align:center;padding: 5px 0px;" class="no_borderleft"  colspan='3'>
				...
				<tr >
					...
					<?php echo $form->textField($model,'StartFuelStock',array('class'=>'span8','readonly'=>'readonly')); ?>
					<br>
				...
				<tr >
					...
					<td style="width:20%;vertical-align:top;text-align:right;" class="no_borderleft">
					<?php echo $form->textField($model,'LastFuelStock',array('class'=>'span8','onChange' => 'javascript:hitung_fuel()')); ?>
					<br>
...
Nautical Section Head
	...
	<?php echo $form->hiddenField($model,'ActualStartDate',array('class'=>'span5')); ?>

	<?php echo $form->hiddenField($model,'ConsumptFuel',array('class'=>'span5')); ?>
