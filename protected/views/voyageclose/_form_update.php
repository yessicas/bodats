...
<table class="tabel_border_o" style =" font-family: 'Calibri';font-size: 12px;width:90%;" >
	...
	<tr>
		...
		<!-- --> 
		<?php echo $form->textField($model,'CloseVoyageNumber',array('class'=>'span7','maxlength'=>32,'readonly'=>'readonly')); ?>
		<br>
	...
	<td style="vertical-align:top;" >
		...
		<td style="width:20%;vertical-align:top;text-align:center;padding: 5px 0px;" class="no_borderleft"  colspan='3'>
				...
				<tr class="even" >
					...
					<?php echo $form->textField($model,'StandardFuel',array('class'=>'span5','readonly'=>'readonly')); ?> Liter
					<br>
					...
					<td style="vertical-align:top;text-align:left;" class="no_borderleft">
					<?php echo $form->textField($model,'ActualFuel',array('class'=>'span5','readonly'=>'readonly')); ?> Liter
					<br>
				...
				<tr class="even" >
					...
					<td style="vertical-align:top;text-align:left;" class="no_borderleft">
					<?php echo $form->textField($model,'StandardLayTime',array('class'=>'span5','readonly'=>'readonly')); ?> Hari 
					<br>
...
Nautical Section Head
	...
	<?php
		...
		//echo $form->textFieldRow($model,'CloseVoyageNumber',array('class'=>'span7','maxlength'=>32,'readonly'=>'readonly')); 
