...
<?php echo $form->errorSummary($model); ?>
	...
	<tr class="even">
		...
		<?php echo $form->textField($model,'sales_code',array('class'=>'span7','maxlength'=>50)); ?>
	...
	<?php echo $form->textField($model,'print_sign_name',array('class'=>'span8','maxlength'=>50)); ?>
	<?php echo $form->error($model,'print_sign_name'); ?> 
	
	<?php echo $form->textField($model,'print_sign_position',array('class'=>'span5','maxlength'=>50)); ?>
	...
	<?php 
	//Capacity diambilkan dari actual capacity
	echo $form->hiddenField($model,'Capacity',array('class'=>'span5', 'value'=>$modelvoyage->ActualCapacity)); ?>
