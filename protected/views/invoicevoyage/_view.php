<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->id_invoice_voyage),array('view','id'=>$data->id_invoice_voyage)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('print_CompanyName')); ?>:</b>
	<?php echo CHtml::encode($data->print_CompanyName); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('print_ShippingAddress')); ?>:</b>
	<?php echo CHtml::encode($data->print_ShippingAddress); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('print_NPWP')); ?>:</b>
	<?php echo CHtml::encode($data->print_NPWP); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('print_NoFakturPajak')); ?>:</b>
	<?php echo CHtml::encode($data->print_NoFakturPajak); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('print_top')); ?>:</b>
	<?php echo CHtml::encode($data->print_top); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('sales_code')); ?>:</b>
	<?php echo CHtml::encode($data->sales_code); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('print_CustomerCode')); ?>:</b>
	<?php echo CHtml::encode($data->print_CustomerCode); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('invoice_marks')); ?>:</b>
	<?php echo CHtml::encode($data->invoice_marks); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('invoice_termdelivery')); ?>:</b>
	<?php echo CHtml::encode($data->invoice_termdelivery); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('invoice_duedate')); ?>:</b>
	<?php echo CHtml::encode($data->invoice_duedate); ?>
	<br />
