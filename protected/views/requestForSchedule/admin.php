...
array('label'=>'Manage RFS '.$titleMenu,'url'=>array('requestForSchedule/admin','mode'=>isset($_GET['mode']) ? $_GET['mode'] : 'DOCKING' ),'active'=>true),
...
<?php if(isset($_GET['mode'])){
    ...
    if($_GET['mode']=='REPAIR'){
        echo'<h2>Manage Request For Schedules Repair</h2>';
        $modelDataProvider=$model->search($_GET['mode']);
    }

    if($_GET['mode']=='DOCKING'){
        echo'<h2>Manage Request For Schedules Docking</h2>';
        $modelDataProvider=$model->search($_GET['mode']);
    }
...
'buttons'=>array(
                'update'=>
                    array(
                        'url'=> 'Yii::app()->createUrl("RequestForSchedule/update",array("id"=>$data->id_request_for_schedule,"mode"=>isset($_GET["mode"]) ? $_GET["mode"] : "DOCKING"))',
                        'options'=>array(
                    ...
                    array(
                        ...
                        'url'=> 'Yii::app()->createUrl("RequestForSchedule/view",array("id"=>$data->id_request_for_schedule))',
                        'options'=>array(
                            'class'=>'various fancybox.ajax',
                            'rel'=>'',
                        ),
                    ...
                    array(
                        ...
                        'url'=> 'Yii::app()->createUrl("RequestForSchedule/delete",array("id"=>$data->id_request_for_schedule))',
