...
<?php if(isset($_GET['mode'])){
    ...
    if($_GET['mode']=='REPAIR'){
        echo'<h2>Approved Request For Schedules Repair</h2>';
        $modelDataProvider=$model->searchapproved($_GET['mode']);
    }

    if($_GET['mode']=='DOCKING'){
        echo'<h2>Approved Request For Schedules Docking</h2>';
        $modelDataProvider=$model->searchapproved($_GET['mode']);
    }
    
}else{
    echo'<h2>Approved Request For Schedules Docking</h2>';
    $modelDataProvider=$model->searchapproved(); 
}
?>
<hr>
