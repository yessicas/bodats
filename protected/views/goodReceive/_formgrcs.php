...
<?php $orderdetail= $_GET['id'];?>
	...
	<?php echo $form->hiddenfield($model,'id_purchase_order_detail',array('class'=>'span3','value'=>$id_purchase_order_detail)); ?>
	...
	<?php echo $form->dropDownListRow($model,'status_receive',array("PARTIAL"=>"PARTIAL","FINAL"=>"FINAL"),
