...
<div id="content">
    <h2>Fuel Good Receive & Good Issue</h2>
    <hr>
    <?php
    /*
      <div class="tambah">
...
//'filter'=>$model,
    'columns' => array(
        ...
        array(
            ...
            'type' => 'raw',
            'value' => '$data->id_purchase_request',
        ),
        //'id_vendor',
        //'up',
        'PO.PONumber',
         ...
         */
        array('header' => 'Fuel Receive (GR) Detail Info',
            'type' => 'raw',
            'htmlOptions' => array('width' => '340px'),
            'value' =>
            function($data) {
    ...
    /*
      array('header'=>'Fuel Issue (GI) Detail Info',
      'type'=>'raw',
      'htmlOptions'=>array('width'=>'240px'),
      'value'=>
      function($data)  {
...
function getDetailReceive($model) {
    ...
    $url = Yii::app()->createUrl("goodReceive/grfuel/", array("id" => $model->id_purchase_order_detail));
    $RES .= '<a href="' . $url . '">Update Fuel Receive</a>';
...
function getDetailIssued($model) {
    ...
    $url = Yii::app()->createUrl("goodIssue/gifuel/", array("id" => $model->id_purchase_order_detail));
    $RES .= '<a href="' . $url . '">Update Fuel Issue</a>';
