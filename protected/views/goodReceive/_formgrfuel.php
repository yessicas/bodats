...
<?php echo $form->dropDownListRow($model, 'metric', CHtml::listData(MstMetricPr::model()->findAll(), 'metric', 'metric_name'), array('prompt' => '--Select--', 'class' => 'span2', 'readonly' => 'readonly'));
?>
...
<?php echo $form->dropDownListRow($model, 'status_receive', array("PARTIAL" => "PARTIAL", "FINAL" => "FINAL"), array('prompt' => '--Select--', 'class' => 'span3'));
?>
...
<?php echo $form->dropDownListRow($model, 'id_vessel', CHtml::listData(Vessel::model()->findAll(), 'id_vessel', 'VesselName'), array('prompt' => '--Select--', 'class' => 'span3'));
?>
