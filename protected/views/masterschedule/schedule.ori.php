...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="controls">
		<?php echo chtml::dropDownList('Month',$monthseacrh,Timeanddate::getlistmonth(),
	...
	<div class="controls">
 <?php echo chtml::dropDownList('Year',$yearseacrh,Timeanddate::getlistyear(),
...
<div class="view">
    ...
    $this->widget('bootstrap.widgets.TbButton', array(
                ...
                'url'=>array('masterschedule/master',
...
<div class="userlistviewall" style="display:inline">
	...
	<?php $this->renderPartial('jadwal',array(
        )); ?>
