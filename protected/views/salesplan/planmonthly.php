...
array('label'=>'Sales Plan Monthly','url'=>array('salesplan/monthly'), 'active'=>true),
...
<?php
	if(isset($_GET['Month'])){
		$month = $_GET['Month'];
		$year = $_GET['Year'];
		echo $this->renderPartial('../salesplan/_salesplantable', array('month'=>$month, 'year'=>$year, 'is_mode'=>'monthly')); 
