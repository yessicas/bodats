...
<div class="view">
	...
	*/
	...
	<?php
		...
		echo $form->dropDownListRow($model,'id_vessel_tug',CHtml::listData(Vessel::model()->findAll(array(
		...
		echo $form->dropDownListRow($model,'id_vessel_barge',CHtml::listData(Vessel::model()->findAll(array(
           'condition' => 'VesselType = :VesselType',
           'params' => array(
               ':VesselType' => "BARGE",
           ),
