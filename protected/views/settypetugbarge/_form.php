...
<?php echo $form->errorSummary($model); ?>
	...
	<?php //echo $form->textFieldRow($model,'voyage_number',array('class'=>'span4')); ?>
	...
	<?php echo $form->dropDownList($model,'tug',VesselDB::getUnpairedVesselTug(),
    array('prompt'=>Yii::t('strings','-- Select --'),'class'=>'span6',
	...
	<?php echo $form->dropDownList($model,'barge',VesselDB::getUnpairedVesselBarge(),
    array('prompt'=>Yii::t('strings','-- Select --'),'class'=>'span6',
