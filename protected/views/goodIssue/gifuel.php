...
$this->breadcrumbs=array(
	...
	array('label'=>'Fuel Good Issue - Detail','url'=>array('goodIssue/gifuel/id/'.$id_purchase_order_detail), 'active'=>true),
...
<?php
    $this->widget('bootstrap.widgets.TbButton', array(      
                ...
                //'url'=>array('create'),   
                'url'=>array('goodIssue/creategifuel','id'=>$model->id_purchase_order_detail),
                'htmlOptions' => array(
                                        'class'=>''
                                        ),
    ));
