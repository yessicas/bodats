<div class="view">
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('id_ehs_item')); ?>:</b>
    <?php echo CHtml::link(CHtml::encode($data->id_ehs_item), array('view', 'id' => $data->id_ehs_item)); ?>
    <br />
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('ehs_category')); ?>:</b>
    <?php echo CHtml::encode($data->ehs_category); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('ehs_item')); ?>:</b>
    <?php echo CHtml::encode($data->ehs_item); ?>
    <br />
