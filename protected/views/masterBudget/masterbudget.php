...
$this->menu=array(
array('label'=>'Generate Master Budget','url'=>array('masterbudget/budget')),
array('label'=>'Master Budget','url'=>array('masterbudget/masterbudget'),'active'=>true),
);
?>
...
<h3> Master Budget <font color="red"> <?php echo $year; ?> </font></h3>
<hr style="margin-top:-10px;">

<?php
	//Datanya nanti disini saja, bagian bawah untuk display result
	/*Revenue*/
	$REVENUE_TONAGE_AFFCO = SalesPlanDB::getTotalRavenueAffcoPerYear($year); //Nanti dibuat query sum untuk tonage (barging dan transhipment)
	$REVENUE_TONAGE_3P = SalesPlanDB::getTotalRavenue3PPerYear($year);
