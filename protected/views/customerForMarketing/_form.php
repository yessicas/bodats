...
<h4 style="color:#BD362F; margin-top:20px;"> Status Info </h4>
	...
	<?php echo $form->dropDownListRow($model,'TypeCategory',array('COAL'=>'COAL', 'NON-COAL'=>'NON-COAL'),array('prompt'=>'--Select--','class'=>'span3'));?>
		...
		<br>User For Marketing<br>
		<select name="mode" >
			
			<option value='current' <?php /*if($mode=="current") {echo "selected";}*/ ?>>--null--</option>
			<option value='past' <?php /*if($mode=="past") {echo "selected";}*/ ?> >--null--</option>
		</select>
	</div>
