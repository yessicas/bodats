...
'buttons'=>array(
                'update'=>
                    array(
                        ...
                        'icon'=>'icon-fa-pencil',
                         'url'=>function($data) use ($module) {
                                return Yii::app()->createUrl($module."/SchedulePlan/update",array("id"=>$data->id_schedule_plan));
                            },
                        'options'=>array(
                    ...
                    array(
                        ...
                        'icon'=>'icon-fa-eye',
                        'url'=>function($data) use ($module) {
                                return Yii::app()->createUrl($module."/SchedulePlan/view",array("id"=>$data->id_schedule_plan));
                            },
                        'options'=>array(
                            'class'=>'various fancybox.ajax',
                            'rel'=>'',
                    ...
                    array(
                         ...
                         'icon'=>'icon-fa-trash',
                         'url'=>function($data) use ($module) {
                                return Yii::app()->createUrl($module."/SchedulePlan/delete",array("id"=>$data->id_schedule_plan));
                            },
