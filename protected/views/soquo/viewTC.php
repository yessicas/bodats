...
$this->menu=array(
    ...
    array('label'=>'View Quotation ', 'url'=>array('quotation/viewTC','id'=>$model->id_quotation)),
);
?>
...
You Can 
<?php echo CHtml::link('Back to Step 2',array('demand/quocreate2TC','id'=>$model->id_quotation)); ?> or <?php echo CHtml::link('Back to step 1 ',array('demand/quoupdate','id'=>$model->id_quotation)); ?>
</div>
...
<?php 
  //echo Timeanddate::countRangeDate($model->TCStartDate,$model->TCEndDate);
?>
