...
array('label'=>'Actual Sales Per Voyage','url'=>array('actualsalesreport/actualpervoyage'),'active'=>true),
...
<h3 style="margin-bottom:-5px;"> Actual Sales Per Voyage </h3>
<hr>
<div class="view">
...
<?php
	if($year > 0){
		echo $this->renderPartial('../actualsalesreport/reportpervoyage', array('month'=>$month, 'year'=>$year , 'model'=>$model)); 
