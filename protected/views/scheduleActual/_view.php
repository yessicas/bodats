<div class="view">
		...
		<b><?php echo CHtml::encode($data->getAttributeLabel('id_schedule_actual')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_schedule_actual),array('view','id'=>$data->id_schedule_actual)); ?>
	<br />
