...
'buttons'=>array(
                'update'=>
                    array(
                        ...
                        'icon'=>'icon-fa-pencil',
                        'url'=> 'Yii::app()->createUrl("ScheduleActual/update",array("id"=>$data->id_schedule_actual))',
                        'options'=>array(
                    ...
                    array(
                        ...
                        'icon'=>'icon-fa-eye',
                        'url'=> 'Yii::app()->createUrl("ScheduleActual/view",array("id"=>$data->id_schedule_actual))',
                        'options'=>array(
                            'class'=>'various fancybox.ajax',
                            'rel'=>'',
                        ),
                    ...
                    array(
                         ...
                         'icon'=>'icon-fa-trash',
                        'url'=> 'Yii::app()->createUrl("ScheduleActual/delete",array("id"=>$data->id_schedule_actual))',
