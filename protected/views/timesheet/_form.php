...
<?php //echo $form->errorSummary($model); ?>
	...
	<?php echo $form->dropDownListRow($model,'id_voyage_activity',CHtml::listData(VoyageMstActivity::model()->findAll(array('order'=>'voyage_activity_desc ASC')),'id_voyage_activity', 'voyage_activity_desc'),
    ...
    <?php /* echo $form->dropDownListRow($model,'JettyId',CHtml::listData(Jetty::model()->findAll(),'JettyId', 'JettyName'),
    array('prompt'=>Yii::t('strings','-- Select --'),'class'=>'span3')); */ ?>
