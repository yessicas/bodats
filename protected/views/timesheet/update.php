...
$this->breadcrumbs=array(
	...
	$model->id_timesheet=>array('view','id'=>$model->id_timesheet),
	'Update',
);
...
array('label'=>'Update Timesheet','url'=>array('timesheet/update','id'=>$model->id_timesheet,'inVoyageClose'=>1)),
);
}else{

$title='Update Data  Update Daily';
$this->menu=array(
...
array('label'=>'Update Daily Update','url'=>array('timesheet/update','id'=>$model->id_timesheet)),
);
}
?>
