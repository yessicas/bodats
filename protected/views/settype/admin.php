...
$this->menu=array(
array('label'=>'Manage Set Tug Barge','url'=>array('settype/admin')),
array('label'=>'Create Set type Tug barge','url'=>array('settype/create'),'linkOptions'=>array('class'=>'various fancybox.ajax',)),
);
