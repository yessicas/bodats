...
<?php 
        ...
        foreach($qdetail as $list_qdetail){
            ...
            echo'<font class="font_data_base">Barge Size : '.$list_qdetail->BargeSize.' Ft, Capacity : '.$list_qdetail->Capacity.' MT </font>';
            echo'</td>';
            echo'<td style="vertical-align:top;">';
            echo'<font class="font_data_base">'.$list_qdetail->Currency->currency.' '.$list_qdetail->Price.'</font>';
            echo'</td>';
            echo'</tr>';
        $i++;
        }
...
<b>CONDITION :</b> <br>
<ol>
<li>Base Fuel  Price : Rp.  <?php echo GeneralDB::getLastUpdateFuel()->fuel_price ?> / Liter (standard harga Pertamina "Wilayah II"), price based on begining of the month.   </li>
...
<li>Deadfreight : <?php echo '<font class="font_data_base">'.GeneralDB::getlastBigListQuotation($model->id_quotation)->Capacity.' MT '; ?> (<?php echo GeneralDB::getlastBigListQuotation($model->id_quotation)->BargeSize ?>  Ft Barge </font>)</li>
<li>Other :</li>
