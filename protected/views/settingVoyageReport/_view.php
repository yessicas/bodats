<div class="view">
		...
		<b><?php echo CHtml::encode($data->getAttributeLabel('id_setting_tax_report')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_setting_tax_report),array('view','id'=>$data->id_setting_tax_report)); ?>
	<br />
