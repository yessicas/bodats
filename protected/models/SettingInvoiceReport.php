...
/**
 * This is the model class for table "setting_invoice_report".
 *
 * The followings are the available columns in table 'setting_invoice_report':
 * @property integer $id_setting_quotation_report
 * @property string $field_name
 * @property string $field_value
 */
class SettingInvoiceReport extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_setting_quotation_report, field_name, field_value', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SettingInvoiceReport the static model class
	 */
