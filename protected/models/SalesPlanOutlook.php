 ...
 */
class SalesPlanOutlook extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SalesPlanOutlook the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('TotalQuantity, PriceUnit, change_rate, FuelLtr, FuelCost, AgencyCost, DepreciationCost, CrewCost, Rent, SubconCost, IncuranceCost, RepairCost, DockingCost, BrokerageCost, OthersCost, GP_COGM, MarginFuelCost, MarginAgencyCost, MarginDepreciationCost, MarginCrewCost, MarginRent, MarginSubconCost, MarginIncuranceCost, MarginRepairCost, MarginDockingCost, MarginBrokerageCost, MarginOthersCost, GP_COGS, TotalStandardCost, TotalSalesCost', 'numerical'),
