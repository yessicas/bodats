...
/**
 * This is the model class for table "schedule_actual".
 *
 * The followings are the available columns in table 'schedule_actual':
 * @property string $id_schedule_actual
 ...
 */
class ScheduleActual extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('VesselTugId, id_voyage_activity_group, schedule_date, sch_month, sch_year, created_date, created_user, ip_user_updated', 'required'),
			...
			array('id_schedule_actual, VesselTugId, VesselBargeId, id_voyage_activity_group, schedule_date, schedule_number, sch_month, sch_year, created_date, created_user, ip_user_updated', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_schedule_actual' => 'Id Schedule Actual',
	...
	public function search()
	{
		...
		$criteria->compare('id_schedule_actual',$this->id_schedule_actual);
	 ...
	 * @return ScheduleActual the static model class
	 */
