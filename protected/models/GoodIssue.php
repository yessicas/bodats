...
class GoodIssue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array(' received_date, receive_by, quantity, metric, receive_number, id_vessel', 'required'),
			array('id_po_category, quantity, receive_number', 'numerical', 'integerOnly'=>true),
			array('amount', 'numerical'),
			array('id_purchase_order, id_purchase_order_detail, id_item, metric', 'length', 'max'=>20),
			...
			array('id_good_issue, id_purchase_order, id_purchase_order_detail, id_po_category, received_date, receive_by, condition, notes, amount, purchase_item_table, id_item, item_add_info, quantity, metric, receive_number, status_receive, created_user, created_date, ip_user_updated, id_vessel, dedicated_to', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_good_issue',$this->id_good_issue,true);
