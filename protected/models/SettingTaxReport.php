...
/**
 * This is the model class for table "setting_tax_report".
 *
 * The followings are the available columns in table 'setting_tax_report':
 * @property integer $id_setting_tax_report
 * @property string $field_name
 * @property string $field_value
 */
class SettingTaxReport extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SettingTaxReport the static model class
	 */
